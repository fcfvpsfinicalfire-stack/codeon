...
const DiscordBanner: React.FC = () => {
  return (
    <section className="bg-blue-600 py-6 border-t border-b border-black/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
        ...
        <a 
          ...
          className="bg-white hover:bg-slate-100 text-blue-600 font-bold py-2.5 px-6 rounded-lg text-sm flex items-center space-x-2 transition-all shadow-lg active:scale-95"
        >
