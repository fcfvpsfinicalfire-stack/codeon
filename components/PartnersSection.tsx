      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-gray-500 font-bold max-w-2xl mx-auto uppercase text-[10px] tracking-[0.25em] leading-relaxed">
            Proudly supporting the creators who power our community.
          </p>
        </div>
          ...
          {PARTNERS.map((partner, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-24 h-24 rounded-full overflow-hidden mx-auto mb-8 ring-4 ring-white/5 group-hover:ring-blue-500/30 transition-all">
                ...
                <h4 className="text-3xl font-black text-white mb-2 uppercase tracking-tighter">{partner.name}</h4>
                ...
                <div className="flex items-center justify-center gap-2 text-white font-black uppercase text-[10px] tracking-widest group-hover:text-blue-400 transition-colors">
                  Visit Channel <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                </div>
              </div>
            </a>
          ))}
        ...
        <div className="mt-24 text-center">
           <div className="glass p-12 rounded-[4rem] border border-white/5 max-w-3xl mx-auto">
              ...
              <a href="https://discord.gg/CHAR4ABVWz" target="_blank" className="inline-block px-12 py-5 bg-blue-600 hover:bg-blue-500 text-white rounded-3xl font-black text-sm uppercase tracking-[0.3em] transition-all shadow-xl shadow-blue-600/20 active:scale-95">
                Apply on Discord
              </a>
           </div>
        </div>
