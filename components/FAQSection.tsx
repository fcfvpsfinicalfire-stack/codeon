        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tighter leading-tight"
            >
            ...
            <motion.p
              ...
              className="text-slate-400 text-sm md:text-base leading-relaxed mb-10 max-w-md font-medium"
            >
            ...
            >
              <button
                ...
                className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 px-8 rounded-lg text-sm transition-all shadow-lg shadow-blue-600/20 active:scale-95"
              >
                View FAQ
              </button>
              <button className="bg-slate-800 hover:bg-slate-700 text-white font-bold py-3 px-8 rounded-lg text-sm transition-all border border-white/5 active:scale-95">
                View Knowledgebase
              </button>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-4">
            {faqs.map((faq, i) => (
              <motion.div
                ...
                className={`bg-slate-900/40 border border-white/5 rounded-xl overflow-hidden transition-all duration-300 ${openId === faq.id ? 'bg-slate-900/80 border-blue-500/20' : 'hover:border-white/10'}`}
              >
                <button
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className="flex-shrink-0 p-2 bg-slate-800 rounded-lg group-hover:bg-slate-700 transition-colors">
                      {faq.icon}
                    </div>
                  ...
                  <div className="text-slate-500">
                    <ChevronDown size={20} className={`transition-transform duration-300 ${openId === faq.id ? 'rotate-180 text-blue-500' : ''}`} />
                  </div>
                </button>
